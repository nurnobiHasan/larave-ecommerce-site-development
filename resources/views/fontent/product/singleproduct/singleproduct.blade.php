...
@section("content")
            ...
            <div class="row">
                        ...
                        <div class="product-active owl-carousel">
                            <div class="item">
                                <div class="img" style="height:550px">
                                    <img style="width:100%;height:100%"  src="{{asset(Storage::url($singleproduct->product_thumbnail))}}" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <img src="{{asset('assets/images/product/detelsproduct/2.jpg')}}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('assets/images/product/detelsproduct/3.jpg')}}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('assets/images/product/detelsproduct/4.jpg')}}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('assets/images/product/detelsproduct/5.jpg')}}" alt="">
                            </div>
                            <div class="item">
                                <img src="{{asset('assets/images/product/detelsproduct/6.jpg')}}" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="product-single-content">
                        ...
                        <p>{{Str::limit($singleproduct->product_summery,80)}}</p>
                        ...
                        <ul class="cetagory">
                            <li>Categories:</li>
                            <li><a href="#">{{$singleproduct->category->name}}</a></li>
                        </ul>
                        <ul class="socil-icon">
                            <li>Share :</li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="description">
                            <div class="description-wrap">
                                <p>{!!nl2br($singleproduct->product_description)!!}</p>
                            </div>
                        </div>
    ...
    <div class="featured-product-area">
        <div class="container">
            ...
            <div class="row">
                @foreach ($alldata as $singlerelatedproduct )
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="featured-product-wrap">
                            <div class="featured-product-img">
                                <img style="height:150px" src="{{url(Storage::url($singlerelatedproduct->product_thumbnail))}}" alt="">
                            </div>
                            <div class="featured-product-content">
                                <div class="row">
                                    <div class="col-7">
                                       <h3><a href="{{url('productitem')}}/{{$singlerelatedproduct->slug}}">{{$singlerelatedproduct->product_name}}</a></h3>
                                        <p>{{$singlerelatedproduct->product_prize}}</p>
                                    </div>
