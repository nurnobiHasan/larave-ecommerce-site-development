                        ...
                        <ul class="d-flex account_login-area">
                            <li>
                                ...
                                <ul class="dropdown_style">
                                    ...
                                    <li><a href="{{asset('registation')}}">Register</a></li>
                                    <li><a href="{{asset('cartpage')}}">Cart</a></li>
                            ...
                            @auth
                                ...
                                @else
                                <li><a href="{{asset('registation')}}">Register Now</a></li>
                            @endauth
                        </ul>
                    </div>
                </div>
            ...
            <div class="fluid-container">
                <div class="row">
                    ...
                    <div class="col-lg-7 d-none d-lg-block">
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                <li class="active"><a href="{{asset('fontenthome')}}">Home</a></li>
                                <li><a href="about.html">About</a></li>
                                <li>
                                    <a href="{{asset('shoppage')}}">Shop</a>
                                </li>
                                <li>
                                    <a href="{{asset('cartpage')}}">Cart</a>
                                    {{-- <ul class="dropdown_style">
